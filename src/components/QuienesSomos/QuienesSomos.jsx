  ...
  return (
    <div>
      ...
      <div className='w-100 developer-container h-96' >
        ...
        <img className='image' src="https://scontent-bog1-1.xx.fbcdn.net/v/t39.30808-6/178625271_4669731599704898_4150218170658490307_n.jpg?_nc_cat=105&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=UptaWZjNUSMAX-sUig0&_nc_ht=scontent-bog1-1.xx&oh=00_AT_uUzieGqKTREpFNmeIvnff_lcaJ3uEzon5RunsuarvkA&oe=62458830" alt="" />
      </div>
    </div>
  )
}
